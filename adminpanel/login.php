...
<style>
    ...
    .login-box{
        ...
        width: 100%;
        max-width: 400px; /* Maksimum lebar untuk desktop */
        padding: 30px;
        border-radius: 15px;
    ...
    @keyframes fadeIn {
     ...
     /* Media Query untuk perangkat ponsel */
    @media screen and (max-width: 480px) {
        .login-box {
            width: 95%; /* Lebar 95% untuk ponsel */
            max-width: 320px;
...
<body>
   <div class="main d-flex flex-column justify-content-center align-items-center">
        <div class="login-box p-4 shadow">
            ...
            <div class="alert-container mt-3" style="width: 400px">
             <?php
