...
if (empty($_SESSION['keranjang'])) {
    $_SESSION['message'] = [
        'type' => 'warning',
        'text' => 'Keranjang Anda kosong. Silakan tambahkan produk terlebih dahulu.',
    ];
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $status_pembayaran = 'pending'; // Default status pembayaran adalah pending

    // Insert data pembayaran ke tabel pembayaran
    $queryInsert = "INSERT INTO pembayaran (total_harga, metode_pembayaran, status_pembayaran) 
                    VALUES ('$totalHarga', '$metode_pembayaran', '$status_pembayaran')";
    ...
    if (mysqli_query($con, $queryInsert)) {
        ...
        $_SESSION['message'] = [
            'type' => 'success',
            'text' => "Pembayaran berhasil! Pembayaran Anda sedang diproses.",
        ];
        ...
        $_SESSION['message'] = [
            'type' => 'danger',
            'text' => "Pembayaran gagal! Silakan coba lagi. Error: " . mysqli_error($con),
        ];
    }
}
?>
...
<body>
    ...
    <div class="container py-5">
        ...
        <?php if (isset($_SESSION['message'])): ?>
            <div class="alert alert-<?php echo $_SESSION['message']['type']; ?> text-center">
                <?php
