            ...
            <div class="row mt-5">
                ...
                <div class="col-md-3 py-3">
                    <div class="highlighted-kategori kategori-baju-wanita d-flex justify-content-center align-items-center">
                         <h4 class="text-white"><a class="no.decoration" href="produk.php?kategori=Baju Wanita" class="text-white no-decoration">Baju wanita</a></h4>
                    </div>
                </div>
                <div class="col-md-3 py-3 ">
                    <div class="highlighted-kategori kategori-sepatu-pria d-flex justify-content-center align-items-center">
                       <h4 class="text-white"><a href="produk.php?kategori=Sepatu Pria" class="text-white no-decoration">Sepatu Pria</a></h4>
                    </div>
                </div>
                <div class="col-md-3 py-3 ">
