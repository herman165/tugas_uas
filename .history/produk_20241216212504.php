...
if(isset($_GET['add_to_cart'])){
    $produk_id = $_GET['add_to_cart']; // Mendapatkan ID produk dari URL
    $jumlah = 1; // Jumlah produk yang ditambahkan (default 1)
    ...
    if(isset($_SESSION['keranjang'])){
        ...
        // Jika keranjang belum ada, buat keranjang baru dan masukkan produk
...
// Menampilkan produk berdasarkan pencarian atau kategori
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <?php 
                    if($countData < 1){
                        echo "<h4 class='col-md-12 text-center'>Produk Yang Anda Cari Tidak Tersedia</h4>";
                    } 
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="produk_detail.php?nama=<?php echo $produk["nama"]; ?>" class="btn btn-primary no-decoration">Lihat Detail</a>
                                    <a href="keranjang.php?add_to_cart=<?php echo $produk['id']; ?>" class="btn btn-success"><i class="fa-solid fa-cart-shopping"></i> Tambah ke Keranjang</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
