...
if (!isset($_SESSION['user_id'])) {
    header('Location: login.php'); // Arahkan ke halaman login jika user belum login
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($con, $queryInsert)) {
        ...
        echo "<div class='alert alert-success'>Pembayaran berhasil! Pembayaran Anda sedang diproses.</div>";
    } else {
