        ...
        <div class="container text-center">
            ...
            <div class="row mt-5">
               <div class="col-sm-6 col-md-3 py-3">
                    <div class="card">
                        <img src="image/Homens Camisa sólido pescoço não trespassado.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-sm-6 col-md-3 py-3">
               ...
               <div class="col-sm-6 col-md-3 py-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text text-tr">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                        </div>
                    </div>
               </div>
