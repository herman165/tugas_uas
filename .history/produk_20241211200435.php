                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <?php 
                            if($countData<1){
                        ?>
                            <h4 class="text-center my-5">Product Yang Anda Cari Tidak Tersedia</h4>
                        <?php        
                            }
                        ?>     
                        ...
                        <?php while($produk = mysqli_fetch_array($queryProduk)){?>
                            <div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    <div class="image-box">
                                        <img src="image/Vans Old Skool Sneakers in Black_White _ VN000D3HY28 - Men 13_Wmn 14_5 _ Black.jpg" class="card-img-top" alt="...">
                                    </div>     
                                    <div class="card-body">
