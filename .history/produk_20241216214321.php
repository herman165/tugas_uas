                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="produk_detail.php?nama=<?php echo $produk["nama"]; ?>"
                                        class="btn-btn warna3 no-decoration text-white">Lihat Detail</a>
                                    <a href="keranjang.php?add_to_cart=<?php echo $produk['id']; ?>"><i
